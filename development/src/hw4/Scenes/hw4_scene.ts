...
export default class hw4_scene extends Scene {
    ...
    loadScene(){
        ...
        this.load.spritesheet("tac_knife_enemy", "hw4_assets/spritesheets/tac_knife_enemy.json");
        this.load.spritesheet("tac_gun_enemy", "hw4_assets/spritesheets/tac_gun_enemy.json");
    ...
    initializeEnemies(){
        ...
        let actionTacticKnife = [new AttackAction(2, [hw4_Statuses.IN_RANGE], [hw4_Statuses.REACHED_GOAL]),
        new Move(2, [], [hw4_Statuses.IN_RANGE], {inRange: 20}),
        new Retreat(4, [hw4_Statuses.LOW_HEALTH, hw4_Statuses.CAN_RETREAT], [hw4_Statuses.REACHED_GOAL], {retreatDistance: 100}),
        new Berserk(2, [hw4_Statuses.LOW_HEALTH, hw4_Statuses.CAN_BERSERK], [hw4_Statuses.REACHED_GOAL])]
 
        let actionTacticGun = [new AttackAction(2, [hw4_Statuses.IN_RANGE], [hw4_Statuses.REACHED_GOAL]),
        new Move(2, [], [hw4_Statuses.IN_RANGE], {inRange: 200}),
        new Retreat(1, [hw4_Statuses.LOW_HEALTH, hw4_Statuses.CAN_RETREAT], [hw4_Statuses.REACHED_GOAL], {retreatDistance: 100}),
        new Berserk(2, [hw4_Statuses.LOW_HEALTH, hw4_Statuses.CAN_BERSERK], [hw4_Statuses.REACHED_GOAL])]
        ...
        let resultTacticGun = this.generateGoapPlans(actionTacticGun, [hw4_Statuses.IN_RANGE, hw4_Statuses.LOW_HEALTH, hw4_Statuses.CAN_BERSERK, hw4_Statuses.CAN_RETREAT], hw4_Statuses.REACHED_GOAL);
        let resultTacticKnife = this.generateGoapPlans(actionTacticKnife, [hw4_Statuses.IN_RANGE, hw4_Statuses.LOW_HEALTH, hw4_Statuses.CAN_BERSERK, hw4_Statuses.CAN_RETREAT], hw4_Statuses.REACHED_GOAL);

        this.testGoapPlans(resultGun, resultKnife, resultTacticKnife, resultTacticGun);
        ...
        for(let i = 0; i < enemyData.numEnemies; i++){
            ...
            else if (data.type === "tac_knife_enemy") {
                weapon = this.createWeapon("knife")
                actions = actionTacticKnife; 
                range = 20;
            }
            else if (data.type === "tac_gun_enemy") {
                weapon = this.createWeapon("pistol")
                actions = actionTacticGun;
                range = 200;
            }
